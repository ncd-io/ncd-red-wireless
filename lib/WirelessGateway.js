			...
			parse: (payload, parsed, mac) => {
				...
				if(payload[8] === 1){
					...
					return {
						...
						x_rms_ACC_mg: payload.slice(12, 14).reduce(msbLsb),
						x_max_ACC_mg: payload.slice(14, 16).reduce(msbLsb),
						...
						y_rms_ACC_mg: payload.slice(26, 28).reduce(msbLsb),
						y_max_ACC_mg: payload.slice(28, 30).reduce(msbLsb),
		...
		'81': {
			...
			parse: (d) => {
				...
				return {
					...
					x1_rms_ACC_mg: d.slice(4, 6).reduce(msbLsb),
					x1_max_ACC_mg: d.slice(6, 8).reduce(msbLsb),
					...
					y1_rms_ACC_mg: d.slice(18, 20).reduce(msbLsb),
					y1_max_ACC_mg: d.slice(20, 22).reduce(msbLsb),
					...
					z1_rms_ACC_mg: d.slice(32, 34).reduce(msbLsb),
					z1_max_ACC_mg: d.slice(34, 36).reduce(msbLsb),
					...
					x2_rms_ACC_mg: d.slice(4, 6).reduce(msbLsb),
					x2_max_ACC_mg: d.slice(6, 8).reduce(msbLsb),
					...
					y2_rms_ACC_mg: d.slice(18, 20).reduce(msbLsb),
					y2_max_ACC_mg: d.slice(20, 22).reduce(msbLsb),
					...
					z2_rms_ACC_mg: d.slice(32, 34).reduce(msbLsb),
					z2_max_ACC_mg: d.slice(34, 36).reduce(msbLsb),
