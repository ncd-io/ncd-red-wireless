		...
		'80': {
			...
			parse: (d) => {
				...
				return {
					...
					x_rms_ACC_mg: d.slice(4, 6).reduce(msbLsb)/1000,
					x_max_ACC_mg: d.slice(6, 8).reduce(msbLsb)/1000,
					x_velocity_mm/sec: d.slice(8, 10).reduce(msbLsb) / 100,
					x_displacement_mm: d.slice(10, 12).reduce(msbLsb) / 100,
					x_peak_one_Hz: d.slice(12, 14).reduce(msbLsb),
					x_peak_two_Hz: d.slice(14, 16).reduce(msbLsb),
					x_peak_three_Hz: d.slice(16, 18).reduce(msbLsb),

					y_rms_ACC_mg: d.slice(18, 20).reduce(msbLsb)/1000,
					y_max_ACC_mg: d.slice(20, 22).reduce(msbLsb)/1000,
					y_velocity_mm/sec: d.slice(22, 24).reduce(msbLsb) / 100,
					y_displacement_mm: d.slice(24, 26).reduce(msbLsb) / 100,
					y_peak_one_Hz: d.slice(26, 28).reduce(msbLsb),
					y_peak_two_Hz: d.slice(28, 30).reduce(msbLsb),
					y_peak_three_Hz: d.slice(30, 32).reduce(msbLsb),

					z_rms_ACC_mg: d.slice(32, 34).reduce(msbLsb)/1000,
					z_max_ACC_mg: d.slice(34, 36).reduce(msbLsb)/1000,
					z_velocity_mm/sec: d.slice(36, 38).reduce(msbLsb) / 100,
					z_displacement_mm: d.slice(38, 40).reduce(msbLsb) / 100,
					z_peak_one_Hz: d.slice(40, 42).reduce(msbLsb),
					z_peak_two_Hz: d.slice(42, 44).reduce(msbLsb),
					z_peak_three_Hz: d.slice(44, 46).reduce(msbLsb),
				};
			}
		},
		'81': {
			...
			parse: (d) => {
				...
				return {
					...
					x1_rms_ACC_mg: d.slice(4, 6).reduce(msbLsb)/1000,
					x1_max_ACC_mg: d.slice(6, 8).reduce(msbLsb)/1000,
					x1_velocity_mm/sec: d.slice(8, 10).reduce(msbLsb) / 100,
					...
					y1_rms_ACC_mg: d.slice(18, 20).reduce(msbLsb)/1000,
					y1_max_ACC_mg: d.slice(20, 22).reduce(msbLsb)/1000,
					y1_velocity_mm/sec: d.slice(22, 24).reduce(msbLsb) / 100,
					...
					z1_rms_ACC_mg: d.slice(32, 34).reduce(msbLsb)/1000,
					z1_max_ACC_mg: d.slice(34, 36).reduce(msbLsb)/1000,
					z1_velocity_mm/sec: d.slice(36, 38).reduce(msbLsb) / 100,
					...
					x2_rms_ACC_mg: d.slice(4, 6).reduce(msbLsb)/1000,
					x2_max_ACC_mg: d.slice(6, 8).reduce(msbLsb)/1000,
					x2_velocity_mm/sec: d.slice(8, 10).reduce(msbLsb) / 100,
					...
					y2_rms_ACC_mg: d.slice(18, 20).reduce(msbLsb)/1000,
					y2_max_ACC_mg: d.slice(20, 22).reduce(msbLsb)/1000,
					y2_velocity_mm/sec: d.slice(22, 24).reduce(msbLsb) / 100,
					...
					z2_rms_ACC_mg: d.slice(32, 34).reduce(msbLsb)/1000,
					z2_max_ACC_mg: d.slice(34, 36).reduce(msbLsb)/1000,
					z2_velocity_mm/sec: d.slice(36, 38).reduce(msbLsb) / 100,
